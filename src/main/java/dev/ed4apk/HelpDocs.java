...
final class HelpDocs {
    private static final String ROOT = "/dev/ed4apk/help/";
    ...
    static void printAll(CommandLine cli) {
        ...
        printCommand(cli, "java -jar ed4apk.jar", out);
        out.flush();
    }
    ...
    @Command(name = "examples", mixinStandardHelpOptions = true,
            ...
            footer = {"", "Examples:",
                    "  java -jar ed4apk.jar examples",
                    "  java -jar ed4apk.jar examples dex-call",
    ...
    static class Examples implements Callable<Integer> {
        ...
        @Override public Integer call() {
            ...
            if (topic == null) {
                ...
                out.println("\nRead: java -jar ed4apk.jar examples dex-call");
                out.println("Save: java -jar ed4apk.jar examples dex-call --file patch.json > patch.json");
                out.println("Full guide: java -jar ed4apk.jar --help-all");
            } else {
