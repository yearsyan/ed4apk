...
@Command(name = "ed4apk", mixinStandardHelpOptions = true,
        description = "APK Quick Editor. Runs with Java 11+; no Android SDK required.",
        footerHeading = "%nExamples:%n",
        footer = {"  java -jar ed4apk.jar info app.apk",
                ...
                "  java -jar ed4apk.jar help apply",
                "", "LLM / first-time use: java -jar ed4apk.jar --help-all",
                "Copyable examples: java -jar ed4apk.jar examples",
                "Raw template: java -jar ed4apk.jar examples dex-call --file patch.json > patch.json",
...
public final class Main implements Runnable {
    ...
    private static void configureHelp(CommandLine cli) {
        ...
        cli.getCommandSpec().version("ed4apk " + (version == null ? "dev" : version));
    ...
    @Command(name = "replace", mixinStandardHelpOptions = true,
            ...
            footer = {"", "Example: ed4apk replace app.apk assets/config.json=./config.json lib/arm64-v8a/libx.so=./libx.so -o edited.apk",
                    ...
                    "For explicit add/replace/delete operations together, use ed4apk apply --help.",
                    "Complete workflow and payload files: java -jar ed4apk.jar examples files"})
    ...
    @Command(name = "apply", mixinStandardHelpOptions = true,
            ...
            footerHeading = "%nExamples:%n",
            footer = {"  ed4apk apply app.apk --patch patch.json -o edited.apk",
                    "  ed4apk apply app.apk --patch patch.json --ks release.p12 --alias release -o signed.apk",
                    ...
                    "Full workflow: java -jar ed4apk.jar examples dex-call; all operation templates: java -jar ed4apk.jar examples batch",
                    "One-call offline reference for LLMs: java -jar ed4apk.jar --help-all"})
    ...
    @Command(name = "refs", mixinStandardHelpOptions = true,
            ...
            footer = {"", "Example: ed4apk dex refs app.apk com.example.Main --json",
    ...
    @Command(name = "rename", mixinStandardHelpOptions = true,
            ...
            footer = {"", "Preview: ed4apk dex rename app.apk com.example.Old com.example.New --dry-run --json",
                    "Apply:   ed4apk dex rename app.apk com.example.Old com.example.New -o renamed.apk",
    ...
    static class DexRename implements Callable<Integer> {
        ...
        public Integer call() throws Exception {
            if (dryRun) {
                ...
                System.out.println("Wrote unsigned APK: " + output + " (use ed4apk sign to install)");
            }
            return 0;
        }
    }
    ...
    @Command(name = "delete", mixinStandardHelpOptions = true,
            ...
            footer = {"", "Example: ed4apk dex delete app.apk com.example.Legacy 'Lcom/example/Unused;' -o edited.apk",
                    "Bulk input: ed4apk dex delete app.apk --classes-file removal.txt --allow-referenced -o edited.apk",
    ...
    @Command(name = "replace", mixinStandardHelpOptions = true,
            ...
            footer = {"", "Example: ed4apk dex replace app.apk Main.smali Other.smali -o edited.apk",
                    ...
                    "Add a helper and update its caller together: java -jar ed4apk.jar examples dex-call"})
    ...
    @Command(name = "add", mixinStandardHelpOptions = true,
            ...
            footer = {"", "Examples:", "  ed4apk dex add app.apk Helper.smali --dex classes.dex -o edited.apk",
                    "  ed4apk dex add app.apk helper.jar --lib android.jar -o edited.apk",
                    ...
                    "Complete workflows: java -jar ed4apk.jar examples dex-call / java -jar ed4apk.jar examples java-class"})
    ...
    @Command(name = "set", mixinStandardHelpOptions = true, description = "Set application label or version",
            footer = {"", "Example: ed4apk manifest set app.apk --label Edited --version-name 2.0 --version-code 2 -o edited.apk",
    ...
    @Command(name = "set-string", mixinStandardHelpOptions = true,
            ...
            footer = {"", "Example: ed4apk resource set-string app.apk 0x7f010000 'New name' --config en -o edited.apk",
    ...
    @Command(name = "sign", mixinStandardHelpOptions = true, description = "Align, sign and verify an APK using a JKS/PKCS12 key",
            footer = {"", "Example: ed4apk sign edited.apk --ks release.p12 --alias release -o signed.apk",
                    "Set ed4apk_KS_PASS or enter the password at an interactive terminal; no plaintext password arguments.",
    ...
    static class SigningOptions {
        ...
        @Option(names = "--ks-pass-env", defaultValue = "ed4apk_KS_PASS", description = "Environment variable containing the keystore password")
